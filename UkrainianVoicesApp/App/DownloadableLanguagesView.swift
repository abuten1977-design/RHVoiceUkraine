...
/// Завантажувані мови ПОВЕРНЕНО у внутрішній збірці 230 (рішення Андрія 08.09.2026).
/// Мета збірки — замір: голос, щойно завантажений, у 222 мовчав до другого
/// перезавантаження (розбір 31.08.2026). Причина не доведена, журнал з телефона
/// знімається кабелем. Перед магазинною збіркою рішення про прапорець приймається
/// заново — за результатом заміру.
private let showDownloadableLanguages = true
